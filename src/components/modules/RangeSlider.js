...
import { formatLargeVndPrice } from "../../helpers/currencyHelper";
...
export default function RangeSlider(props) {
  ...
  const placeSlider = (
    ...
    if (isMin) {
      props.onMinChange(state.displayVal * 1000);
    } else {
      props.onMaxChange(state.displayVal * 1000);
    }
    ...
    <View style={s.mainContainer}>
      <View style={s.container}>
        {/* <View style={s.labelValue}>
          <Text style={s.labelValueText}>
            {formatLargeVndPrice(min_animState.displayVal)}
          </Text>
        </View> */}
        <View
          style={[
        ...
        {/* <View style={s.labelValue}>
          <Text style={s.labelValueText}>
            {formatLargeVndPrice(max_animState.displayVal)}
          </Text>
        </View> */}
      </View>
    </View>
