...
import Carousel, { Pagination } from '../SnapCarousel/index'
  ...
  get pagination() {
    ...
    return (
      <Pagination
        ...
        dotColor={dotColor || colors.white}
        inactiveDotColor={inactiveDotColor || colors.dotColors}
